...
<form action="" method="" enctype="multipart/form-data">
    ...
    <div class="form-group row mb-3">
        ...
        <input name="plan_text" type="text" class="form-control p-5 pt-2 pb-2 pr-0" required>
        </div>
    </div>
    <div class="form-group row mb-3">
        ...
        <input name="plan_amount" type="text" class="form-control p-5 pt-2 pb-2 pr-0" required>
        </div>
    </div>
    <div class="form-group row mb-3">
        ...
        <input name="plan_discount" type="text" class="form-control p-5 pt-2 pb-2 pr-0" required>
        </div>
    </div>
    <div class="form-group row mb-3">
        ...
        <div class="col-sm-7">
            <span><i class="bi bi-file-text-fill web-info-icon text-muted"></i></span>
        <input name="plan_discount" type="text" class="form-control p-5 pt-2 pb-2 pr-0">
        </div>
    </div>
    <div class="form-group row mb-3">
...
<h4>Customize Web-Info</h4>
    ...
    <?php $i=1 ?>
      ...
      <th scope="row"> {{ $i }} </th>
                ...
                <td class="text-center">{{ $each_info->business_address1 }}</td>
                <td class="text-center">{{ $each_info->business_address2 }}</td>
                <td class="text-center">{{ $each_info->business_phone }}</td>
                <td class="text-center">{{ $each_info->business_email }}</td>
                <td class="text-center">{{ $each_info->business_website }}</td>
                <td class="text-center"> {{ $each_info->business_location }} </td>
