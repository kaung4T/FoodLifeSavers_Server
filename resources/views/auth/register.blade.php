        ...
        <div class="card-body">
            <form action="{{route('register')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3 user-id">
                        <span class="fa-solid fa-user icon_register"></span> 
                ...
                <div class="form-group mb-3 user-id">
                        <span class="fa-solid fa-envelope icon_register"></span>
            ...
            <div class="form-group mb-3">
                ...
                <div class="form-group mb-3 user-id select-box">
                        <span class="fa-solid fa-globe country_icon_register"></span>
                        <select id="country" name="country" class="account_country">
